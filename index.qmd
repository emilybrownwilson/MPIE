...
gen groups=0 if program==1 & v007==2008  /* intervention group at baseline */
replace groups=1 if program==1 & v007==2013 /* intervention group at endline */
replace groups=2 if program==0 & v007==2008 /* comparison group at baseline */
replace groups=3 if program==0 & v007==2013 /* comparison group at endline */
```
...
dat$groups <- NA
dat$groups[dat$program==1 & dat$v007==2008] <- 0 # intervention group at baseline #
dat$groups[dat$program==1 & dat$v007==2013] <- 1 # intervention group at endline #
dat$groups[dat$program==0 & dat$v007==2008] <- 2 # comparison group at baseline #
dat$groups[dat$program==0 & dat$v007==2013] <- 3 # comparison group at endline #
